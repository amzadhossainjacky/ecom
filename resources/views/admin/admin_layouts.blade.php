      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Chategory</span>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('coupons')}}" class="nav-link">Create Coupon</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.site_setting')}}" class="nav-link">SiteSetting</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.return.order')}}" class="nav-link">Return order</a></li>
          <li class="nav-item"><a href="{{route('admin.view.return.order')}}" class="nav-link">All Return order</a></li>
