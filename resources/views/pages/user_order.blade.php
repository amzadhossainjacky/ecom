...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <table class="table " style="background: rgb(197, 190, 190)">
                <tr>
                    <th>Name: </th>
                    <th>{{ $order->name }}</th>
                </tr>
        ...
        <div class="col-lg-10 mt-4">
            <div class="text-center"><h3>Product Details</h3></div>
            <table  class="table display responsive nowrap" style="background: rgb(197, 190, 190)">
                <thead>
                  <tr>
