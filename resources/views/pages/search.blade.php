				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						...
						<div class="product_grid row">
							...
							<a href="{{ url('product/details/'.$pro->id.'/'.$pro->product_title) }}">
                                <div class="product_item is_new ">
                                    ...
                                    <div class="product_content">
                                        ...
                                        <div class="product_name"><div><a href="{{ url('product/details/'.$pro->id.'/'.$pro->product_title) }}" tabindex="0">{{ $pro->product_title }}</a></div></div>
                                    </div>
