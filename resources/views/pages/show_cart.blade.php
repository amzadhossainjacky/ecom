				...
				<div class="col-lg-12 ">
					<div class="cart_container">
								...
								<li class="cart_item clearfix">
									...
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										...
										<div class="cart_item_quantity cart_info_col">
											...
											<form method="post" action="{{route('update.cart', $row->rowId)}}" class="mt-2">
												@csrf
										...
										<div class="cart_item_total cart_info_col">
											...
											<a href="{{route('remove.cart', $row->rowId)}}" class="btn btn-danger btn-sm mt-2">Remove</a>
										</div>
									</div>
								</li>
								@endforeach
						...
						<div class="cart_buttons">
							<a href="{{route('user.cancel.cart')}}" class="button cart_button_checkout">All Cancel</a>
